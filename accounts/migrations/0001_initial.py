# Generated by Django 5.0.2 on 2024-07-31 16:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('VIP', 'VIP'), ('VVIP', 'VVIP'), ('VVVIP', 'VVVIP')], max_length=5)),
                ...
                ('invitationCode', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.invitationcode')),
            ],
            options={
                'verbose_name': 'User',
